...
class CreditCartXendit extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'xendit:credit';
     ...
     * @var string
     */
    protected $description = 'check order subscribtion and send to xendit';
